...
I have included all training logs for both the Pytorch and Tensorflow models, and kept the output for the ipynb Tensorflow/Keras trainings scripts so that all training and accuracy results can be verified directly. 
